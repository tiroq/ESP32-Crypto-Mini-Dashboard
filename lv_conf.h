...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (40U * 1024U)          /*[bytes]*/  /* Reduced from 48KB to 40KB for OTA */
...
#define LV_USE_IME_PINYIN 0
    ...
    /* 1: Use default thesaurus. If you do not use the default thesaurus, be sure to use `lv_ime_pinyin` after setting the thesaurus */
    #define LV_IME_PINYIN_USE_DEFAULT_DICT 1
    /* Set the maximum number of candidate panels that can be displayed. This needs to be adjusted according to the size of the screen. */
...
/* 1: Enable the APIs `lv_obj_set_flex_flow()`and `lv_obj_set_flex_align()` */
#define LV_USE_FLEX 1

/* 1: Enable the APIs `lv_obj_set_grid_dsc_array()` and `lv_obj_set_grid_align()` */
